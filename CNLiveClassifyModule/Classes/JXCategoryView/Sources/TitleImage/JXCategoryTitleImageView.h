...
@protocol JXCategoryTitleImageViewDelegate <NSObject>

- (void)refreshStatusBarColorWithLightContent:(BOOL)lightContent backgroundColor:(NSString *)backgroundColor;
...
@property (nonatomic, strong) NSArray <NSString *> *bgColors;

@property (nonatomic, strong) NSArray <NSString *> *statusBarColors;
...
@property (nonatomic, weak) id <JXCategoryTitleImageViewDelegate>refreshStatusBarDelegate;
