...
#define kCNLiveDefaultUserCircleIcon      [UIImage cnlive_imageWithColor:[UIColor grayColor] size:CGSizeMake(60, 60) cornerRadius:0]
/**
 *  weakSelf
 */
#ifndef weakself
...
{
    [self zx_setCircleHeader:url];
}

- (void)zx_setRectHeader:(NSString *)url
{
    [self sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:kCNLiveDefaultUserCircleIcon];
}

- (void)zx_setCircleHeader:(NSString *)url
{
    weakself
    UIImage *placeholder = [kCNLiveDefaultUserCircleIcon zx_circleImage];
    [self sd_setImageWithURL:[NSURL URLWithString:url] placeholderImage:placeholder completed:
     ^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
         ...
         weakSelf.image = [image zx_circleImage];
     }];
}
