...
@implementation NSString (CNLiveExtension)
...
+ (NSDictionary *)jsonToDictionaryWithJson:(NSString *)jsonStr {
    if (CNLiveStringIsEmpty(jsonStr)) {
        return nil;
    }
...
- (BOOL)isEmptyString
{
    if (!self || ![self isKindOfClass:[NSString class]] || self.length == 0 || [self stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]].length == 0) {
        return YES;
    }
    return NO;
}
...
- (CGSize)textSizeIn:(CGSize)size font:(UIFont *)afont breakMode:(NSLineBreakMode)abreakMode align:(NSTextAlignment)alignment
{
    ...
    UIFont *font = (afont != nil) ? afont : UIFontCNMake(14);
...
{
    /*
     //    NSString * MOBILE = @"^0?(13[0-9]|15[012356789]|18[02356789]|14[57])[0-9]{8}$";
     NSString * MOBILE = @"^((1[3,5,8][0-9])|(14[5,7])|(17[0,6,7,8]))[0-9]{8}$";
...
+ (BOOL)validateCellPhoneNumber:(NSString *)cellNum{
    ...
    /**
     ...
     16         * 130,131,132,152,155,156,166,185,17,186
     17         */
    NSString * CU = @"^1(3[0-2]|5[256]|66|7[0-9]|8[56])\\d{8}$";
...
+ (NSString *)filterUnknownChara:(NSString *)text
{
    ...
    //    static {
    //        sSelfEmojisMap.put(0xE415, 0x1f605);
    //        sSelfEmojisMap.put(0xE40C, 0x1f637);
    //        sSelfEmojisMap.put(0xE412, 0x1f602);
    //        sSelfEmojisMap.put(0xE409, 0x1f445);
    //        sSelfEmojisMap.put(0xE40D, 0x1f633);
    //        sSelfEmojisMap.put(0xE107, 0x1f631);
    //        sSelfEmojisMap.put(0xE403, 0x1f614);
    //        sSelfEmojisMap.put(0xE40E, 0x1f612);
    //
    //        sSelfEmojisMap.put(0xE11B, 0x1f47b);
    //        sSelfEmojisMap.put(0xE41D, 0x1f64f);
    //        sSelfEmojisMap.put(0xE14C, 0x1f4aa);
    //        sSelfEmojisMap.put(0xE312, 0x1f389);
    //        sSelfEmojisMap.put(0xE112, 0x1f381);
    //    }
    NSArray *unknownUnicharArray = @[
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)58130],
                                         @"replacSting":[NSString stringWithFormat:@"%C%C",(unichar)55356,(unichar)57225]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE415],
                                         @"replacSting":[NSString stringWithFormat:@"%C%C",(unichar)0x1f605,(unichar)57225]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE40C],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f637]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE412],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f602]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE409],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f633]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE40D],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f605]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE107],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f631]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE403],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f612]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE11B],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f47b]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE14C],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f4aa]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE41D],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f64f]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE312],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f389]
                                         },
                                     @{
                                         @"originSting":[NSString stringWithFormat:@"%C",(unichar)0xE112],
                                         @"replacSting":[NSString stringWithFormat:@"%C",(unichar)0x1f381]
                                         }
                                     ];
    for (NSDictionary *dic in unknownUnicharArray) {
        text = [text stringByReplacingOccurrencesOfString:dic[@"originSting"] withString:dic[@"replacSting"]];
    }
    return text;
}
